...
fext     = 2300.0*Hz    # Background input
...
mu       = 1.*38.0*Hz   # stimulus strength
#mu       = 33.0*Hz     # stimulus strength
pk       = 1.*0.15      # Pulse strength, relative to/ percentage of mu..                            #Set 0 until I get to pulse/duration paradigm/ PsychoPhysical Kernel, and change things around...
